      ...
      <main className="min-h-screen pt-24 pb-16 bg-[#F8FAFC] flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-extrabold text-[#0F1B35] tracking-tight">Create Inspector Account</h1>
            <p className="text-[#64748B] text-xs sm:text-sm">Start verifying packaged commodity compliance instantly</p>
          </div>
          <SignupForm />
